      ...
      <!-- Header Section End -->
        ...
        <div class="page-title-section section">
            <div class="page-title">
                <div class="container">
                    <h1 class="title">Content Creator Fellowship</h1>
                    <h3 style="text-align:center;">6 month rigorous program where you hone content skills & work on professional approach to generate business</h3>
                </div>
            </div>
                        ...
                        <div class="course-details-wrapper">
                            <div class="course-nav-tab">
                                <ul class="nav">
                                    ...
                                    <li><a data-bs-toggle="tab" href="#takeaway">Key Takeaway</a></li>
                                    <li><a data-bs-toggle="tab" href="#usp">What makes us Unique</a></li>
                                            ...
                                            <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <h5 class="title">Content Design</h5>
                                            ...
                                            <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <h5 class="title">Technical Coaching</h5>
                                            ...
                                            <li class="single-curriculum-section">
                                                <div class="section-header">
                                                    <div class="section-left">
                                                        ...
                                                        <h5 class="title">Business Coaching</h5>
...
<!-- Mirrored from template.hasthemes.com/maxcoach-v1/maxcoach/course-details-sticky-feature-bar.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 07 Oct 2021 09:19:51 GMT -->
</html>
